          ...
          @endif
                        <div id="slide01">
                           ...
                           <div class="mb-3 text-start">
                              ...
                              <input type="text" class="form-control" id="FormControlInput1" placeholder="First Name" name="fname" >
                           </div>
                           <div class="mb-3 text-start">
                              <label for="FormControlInput2" class="form-label">Last Name</label>
                              <input type="text" class="form-control" id="FormControlInput2" placeholder="Last Name" name="lname" >
                           </div>
                           <div class="mb-3 text-start">
                        ...
                        <div id="slide02" style="display:none;">
                           ...
                           <div class="mb-3 text-start">
                              ...
                              <input type="email" class="form-control" id="FormControlInput4" placeholder="Email Address" name="email" required="required">
                           </div>
                           <div class="mb-3 text-start">
                              <label for="FormControlInput5" class="form-label">Phone Number</label>
                              <input type="text" class="form-control" id="FormControlInput5" placeholder="Phone Number" name="phone" required="required">
                           </div>
                           <div class="mb-3 text-center">
